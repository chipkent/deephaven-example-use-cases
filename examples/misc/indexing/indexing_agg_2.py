...
t =  empty_table(100_000_000).update(["I = ii % 100", "J = ii % 7", "V = random()"])

idx = has_data_index(t, ["I", "J"])
print(f"Has index: {idx}")
time_it("without index", lambda : t.count_by("Count", ["I", "J"]))
...
idx = has_data_index(t, ["I", "J"])
print(f"Has index: {idx}")
time_it("with index", lambda : t.count_by("Count", ["I", "J"]))
