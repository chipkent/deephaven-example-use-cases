...
#
# In this case, a simple NumPy summation is used for the AI model, but TensorFlow, PyTorch, or any 
...
preds_history = preds.snapshot_when(trigger_table=preds, stamp_cols=[], history=True)
